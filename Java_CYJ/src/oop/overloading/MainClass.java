...
public class MainClass {
	...
	public static void main(String[] args) {
        ...
        */
		...
		//calc.calcRectArea(5);
		System.out.println("길이가 5인 정사각형의 넓이 =  " + calc.calcRectArea(5));
		System.out.println("가로 10 세로 20인 직사각형의 넓이 =  " + calc.calcRectArea(10, 20));
		System.out.println("윗변 5, 밑변 13, 높이 7인 (등변)사다리꼴의 넓이 =  " + calc.calcRectArea(5,13,7));
