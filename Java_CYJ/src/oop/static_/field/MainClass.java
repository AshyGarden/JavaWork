...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("정적 변수 c1.b: " + c1.b);
		System.out.println("정적 변수 c2.b: " + c2.b); //값을 하나를 공유하고 있음		
		System.out.println("정적 변수 Count.b: " + Count.b); //이런 방식으로 불러줌
		/*
		 - static이 붙은 데이터는 그 static데이터가 선언된 클래스 이름으로 바로참조
		 -일반멤버변수와 혼동가능성이 있기에 주소값으로 접근x
